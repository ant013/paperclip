...
- requireInstructionsFile (boolean, optional): fail before launching Codex when instructionsFilePath is empty, unreadable, or not a regular file; defaults to false
...
- If requireInstructionsFile is true, Paperclip refuses to launch Codex unless instructionsFilePath resolves to a readable regular file.
